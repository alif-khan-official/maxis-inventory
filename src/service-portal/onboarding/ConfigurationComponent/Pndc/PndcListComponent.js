...
import '../../../../App.css';
import PndcConfigureComponent from './PndcConfigureComponent';

class PndcListComponent extends React.Component {
...
export default withRouter(PndcListComponent);