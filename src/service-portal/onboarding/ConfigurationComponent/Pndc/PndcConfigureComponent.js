...
import ColumnData from './PndcConfigColumnData';
import '../../../../App.css';
class PndcConfigureComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        try {
            fetch(gwUrl + this.state.apiList['PNDC'].api.substring(1), {
                method: this.state.apiList['PNDC'].type,
                headers: {
                    'Content-Type': 'application/json',
                    'token': 'Bearer ' + AuthUtil.getIdToken(),
                    'userid': AuthUtil.getUserId()
            ...
            <div className="p-grid p-fluid">
                <div className="p-col-12 p-lg-5 p-order-md-1">
                    <Dropdown
                        ...
                        placeholder="Select P&DC"
                        optionLabel="name" />
                </div>
                <div className="p-col-12 p-lg-2 p-order-md-3">
                    <Button
                        label="Add"
                        onClick={() => { this.save() }}
...
export default withRouter(PndcConfigureComponent);