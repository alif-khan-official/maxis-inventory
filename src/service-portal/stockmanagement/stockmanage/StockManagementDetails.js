...
class StockManagementDetails extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div className="card">
        <div className="p-d-flex border">
          <div className="p-col-12 p-lg-12">
            <div className="table-header">Stock Management Details</div>
          </div>
        </div>
...
export default withRouter(StockManagementDetails);
