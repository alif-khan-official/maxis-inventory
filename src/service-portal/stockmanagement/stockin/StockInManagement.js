...
class StockInManagement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      variants: [],
    ...
    this.list = {
      path:
        "maxisservice-inventory-service/endpoint/api/inventory-receive/" +
      ...
      <div className="card">
        <div className="p-d-flex border">
          <div className="p-col-12 p-lg-12">
            <div className="table-header">Stock In Management</div>
          </div>
        </div>
...
export default withRouter(StockInManagement);
