				...
				<div>
					<table className="width100">
						<tbody className="width100">
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Send SMS for new sale</label>
								</td>
								<td className="width75">
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Send SMS for new deposit</label>
								</td>
								<td className="width75">
									<div className="width25">
