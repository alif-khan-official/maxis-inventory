...
class CreditCollectionManagement extends React.Component {
	constructor(props) {
		...
		this.pageTitle = "Business House Settings";

		this.list = {
			path: "authorization-service/endpoint/user/list-by-role",
			headers: {
	...
	getComponentDesign() {
		let columnData = [];
			...
			columnData = [
				{ name: "Business House", selector: "customer", style: { width: "250px" } },
				{
					name: "Amount",
					selector: "amount",
