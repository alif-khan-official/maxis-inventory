...
import SearchableDropdownComponentCreditSale	from "../creditsale/SearchableDropdownComponentCreditSale"	;
import FileComponent from "../../../widgets/FileComponent"	;
import DateTimeComponentCreditSale from "../creditsale/DateTimeComponentCreditSale";

class CreditCollectionNew extends React.Component {
	constructor(props) {
		super(props);
				...
				<div>
					<table className="width100">
						<tbody className="width100">
								...
								<td className="width75">
									<div className="d-flex">
										<input
					                        ...
					                        id={this.state.id + "-moneyReceiptNumber"}
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Deposit Date</label>
								</td>
								<td className="width75">
									<div className="d-flex">
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Receipt</label>
								</td>
								<td className="width75">
									<div className="d-flex">
 										<FileComponent
...
export default withRouter(CreditCollectionNew);
