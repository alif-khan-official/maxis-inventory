...
class CreditCollectionDetails extends React.Component {
	constructor(props) {
		...
		if (!this.state) this.state = this.props.location.state; 
	...
	async loadDetails()
	{
		...
		let customerListResponse = await fetch	(	gwUrlMO + "maxisservice-service/endpoint/credit-collection/get-by-id", 
												            {
												                "method"	: "POST",
												                "headers"	:	{
		...
		let creditSale = customerListJson.creditCollection[0];
		...
		this.setInputValue("moneyReceiptNumber", creditSale.moneyReceiptNumber);
		this.setInputValue("collectionDate", creditSale.collectionDate);

		this.setInputValue("remainingAmount", creditSale.remainingAmount);
		this.setInputValue("handlerName", creditSale.handlerName);
		this.setInputValue("creditSales", creditSale.creditSales);
						...
						<tbody className="width100">
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Collection ID</label>
								</td>
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Collection amount</label>
								</td>
								<td className="width75">
									<div className="d-flex">
 										{this.state.amount}
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Collection date</label>
								</td>
								<td className="width75">
									<div className="d-flex">
							...
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Money receipt no.</label>
								</td>
								<td className="width75">
									<div className="d-flex">
 										{this.state.moneyReceiptNumber}
									</div>
								</td>
							</tr>
							<tr className="width100">
								<td className="width25">
									<label className="form-input-label2">Available for adjustment</label>
								</td>
								<td className="width75">
									<div className="d-flex">
				...
				<div>
					<table className="width100">
						<tbody className="width100">
							<tr className="width100">
								<td className="width25">
									<h4><label className="form-input-label2">Collection Distribution</label></h4>
								</td>
							</tr>
							<tr className="width100">
								<td className="width25">
									<DataTable
										value={this.state.creditSales}
										paginator
										rows={10}
