...
class SchemeDetails extends React.Component {
	...
	handleInstallment(action, installment) 
	{
		...
		{
			let payLoad = {"installmentId": installment.id, "senderId": AuthUtil.getUserId()};
	        try {
	...
	getComponentDesign() 
	{
		let columnInstallmentData =	[
										...
										{	"name"			: "Date"	,	"selector"		: "installmentDate"				, "style":{"width": "100px", "textAlign":"right"}},
										{	"name"			: "Paid"	,	"selector"		: "installmentSubmissionDate"	, "style":{"width": "150px", "textAlign":"right"}},
									]
		;
		let columnNotificationData =	[
										{	"name"			: "Installment"	,	"selector"		: "installmentSerial"			, "style":{"width": "100px", "textAlign":"right"}},
										{	"name"			: "Date"		,	"selector"		: "notificationDateString"		, "style":{"width": "100px", "textAlign":"right"}},
										{	"name"			: "Content"		,	"selector"		: "notificationContent"			, "style":{"width": "250px", "textAlign":"left"}},
									]
		;
		...
		let design = 
					<div className="card-form-body">
						...
						<div>
							<table className="width100">
								<tbody className="width100"> 
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													placeholder="ID"
													id="id"
													value={this.state.data.id === undefined? "":this.state.data.id}
													readOnly={true}
												/> 
											</div>
										</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													id="customerId"
													value={this.state.data.customer.userId === undefined?"":this.state.data.customer.userId}
													readOnly={true}
													filter={false}
												/> 
											</div>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													id="customerName"
													value={this.state.data.customer.name === undefined?"":this.state.data.customer.name}
													readOnly={true}
												/> 
											</div>
										</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													value={this.state.data.customer.phoneNumber === undefined?"":this.state.data.customer.phoneNumber}
													readOnly={true}
												/> 
											</div>
										</td>
									...
									{
										AuthUtil.getRole(0).code === "Maxis-Services-MM-Administrator" &&
										<tr className="width100">
											<td className="width25">
											...
											<td className="width75">
												<div className="d-flex">
			 										<InputFieldComponentv2
														...
														placeholder="Branch"
														id="branchName"
														value={this.state.data.localMerchant.name === undefined?"":this.state.data.localMerchant.name}
														readOnly={true}
													/> 
												</div>
											</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													placeholder="Issuer"
													id="issuerName"
													value={this.state.data.creator.name === undefined?"":this.state.data.creator.name}
													readOnly={true}
												/> 
											</div>
										</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													id="issuedOn"
													value={this.state.data.creationDate === undefined?"":this.state.data.creationDate.substring(0, 10)}
													readOnly={true}
												/> 
											</div>
										</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													readOnly={true}
													value={this.state.data.schemeDetails === undefined?"":this.state.data.schemeDetails}
												/> 
											</div>
										</td>
									</tr>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													value={this.state.data.schemeAmount === undefined?"":this.state.data.schemeAmount}
													readOnly={true}
												/> 
											</div>
										</td>
										...
										<td className="width75">
											<div className="d-flex">
		 										<InputFieldComponentv2
													...
													id="installmentCount"
													value={this.state.data.schemeInstallmentCount === undefined?"":this.state.data.schemeInstallmentCount}
													readOnly={true}
												/> 
											</div>
										</td>
							...
							<div className="divsuccess">
								<div width="100%" style={{"textAlign": "left", "backgroundColor": "#22cc22", "color": "#ffffff"}}>
									<h5>
										...
										Installment {this.state.installResultPresent.serial} is marked paid.
									</h5>
								</div>									
				                <hr />
							</div>
						}
						{
							...
							<div  className="divfailure">
								<div width="100%" style={{"textAlign": "left", "backgroundColor": "#ff7777", "color": "#ffffff"}}>
									<h5>
										<span role="img" aria-labelledby="panda1">❌</span>
										Installment {this.state.installResultPresent.serial} payment update operation failed.
									</h5>
								</div>
				                <hr />
							</div>
						}
						{
							...
							<div className="divsuccess">
								<div width="100%" style={{"textAlign": "left", "backgroundColor": "#22cc22", "color": "#ffffff"}}>
									<h5>
										<span role="img" aria-labelledby="panda1">✅</span>
										Installment {this.state.installResultPresent.serial} notification is sent successfully..
									</h5>
								</div>									
				                <hr />
							</div>
						}
						{
							...
							<div  className="divfailure">
								<div width="100%" style={{"textAlign": "left", "backgroundColor": "#ff7777", "color": "#ffffff"}}>
									<h5>
										<span role="img" aria-labelledby="panda1">❌</span>
										Installment {this.state.installResultPresent.serial} notification send operation failed.
									</h5>
								</div>
				                <hr />
							</div>
						...
						<hr/>
						<div width="100%" style={{"textAlign": "center"}}>
							<h3><b>Installments</b></h3>
							<hr/>
						</div>
						<div className="p-grid p-fluid">
							<div className="datatable-filter-demo">
								<DataTable value={installmentData} paginator rows={10} className="p-datatable-customers">
						...
						<div className="p-grid p-fluid">
							<div className="datatable-filter-demo">
								<DataTable value={notificationData} paginator rows={10} className="p-datatable-customers">
...
export default withRouter(SchemeDetails);
